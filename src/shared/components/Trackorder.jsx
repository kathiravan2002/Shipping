...
const Trackorder = () => {
  ...
  const fetchOrderStatus = async () => {
    try {
      const response = await axios.get(
        `http://192.168.29.12:5000/api/order/track/${orderId}`
      );
  ...
  return (
    <div className="min-h-screen ">
      {/* <div className="min-h-screen flex items-center justify-center bg-cover bg-fixed"  style={{ backgroundImage: `url(${tracking})`}}> */}
